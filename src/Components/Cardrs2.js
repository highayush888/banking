...
const Cardrs1 = () => {
 ...
 return (
    <div className="cardrs2-container">
      {/* <h2>Services</h2> */}
      <div className="cardrs2-wrapper">
        {cardrsItems.map((cardrs2) => (
          // <Link to={cardrs2.link} key={cardrs2.id} className="cardeee-link">
          <div className="sol2-card" key={cardrs2.id}>
          <Link to={cardrs2.link} className="card-link">
            <img src={cardrs2.image} alt={cardrs2.title} />
            <div className="cardrs2-content">
              <h3>{cardrs2.title}</h3>
              <p className="cardrs2content">{cardrs2.content}</p>
            </div>
            </Link>
          </div>
          // </Link>
